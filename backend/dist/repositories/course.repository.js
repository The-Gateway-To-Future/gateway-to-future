...
class CourseRepository {
    static async findAll() {
        ...
        const result = await database_1.db.query('SELECT id, title, description, level, price, capacity, enrolled_count, start_date, end_date, created_at FROM courses ORDER BY level ASC, created_at DESC');
    ...
    static async findById(id) {
        ...
        const result = await database_1.db.query('SELECT id, title, description, level, price, capacity, enrolled_count, start_date, end_date, created_at FROM courses WHERE id = $1', [id]);
    ...
    static async create(course) {
        ...
        const result = await database_1.db.query(`INSERT INTO courses (title, description, level, price, capacity, start_date, end_date)
    ...
    static async incrementEnrollment(id) {
        ...
        const result = await database_1.db.query(`UPDATE courses 
       SET enrolled_count = enrolled_count + 1 
       WHERE id = $1 AND enrolled_count < capacity
       RETURNING enrolled_count`, [id]);
